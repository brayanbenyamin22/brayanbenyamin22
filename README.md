...
I'm **Brayan Navarro**, a **Full-stack Developer** focused on building modern, clean and functional digital experiences.

Through my personal brand **BN CODE**, I combine **frontend development**, **backend logic**, **UI design**, and **creative problem solving** to transform ideas into real digital products.

- 💻 Full-stack Developer
- 🎨 Passionate about UI/UX and visual identity
- ⚡ Building web apps, mobile apps and digital platforms
- 🧠 Always learning, experimenting and improving
- 🧩 Creator of digital products, apps and brands
- 🌎 Based in Panamá
...
### `Code with identity. Design with purpose.`

</div>

**BN CODE** is my personal developer brand.  
It represents my way of building software: clean, creative, useful and visually strong.

My goal is simple:

> Build digital products that look great, feel smooth and solve real problems.
...
- UI dashboards
- Local-first apps
- Digital experiences powered by AI
...
const brayan = {
  ...
  mission: "Build clean, useful and visually powerful digital products.",
  motto: "Code. Design. Impact."
};
```
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00F5FF,100:7B2CBF&height=120&section=footer"/>
